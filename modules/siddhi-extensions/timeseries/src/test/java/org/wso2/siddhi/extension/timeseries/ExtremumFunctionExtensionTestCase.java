...
public class ExtremumFunctionExtensionTestCase {
    static final Logger log = Logger.getLogger(ExtremumFunctionExtensionTestCase.class);
    ...
    @Test
    public void testMinFunctionExtension() throws InterruptedException {
        log.info("MinFunctionExtension TestCase");
        ...
        String query = ("@info(name = 'query1') from inputStream " +
                "select timeseries:min(price1, price2, price3) as min " +
