...
public class KernelMaxWindowExtensionTestCase {
    static final Logger log = Logger.getLogger(KernelMaxWindowExtensionTestCase.class);
    ...
    public void testKernelMaxWindowExtension() throws InterruptedException {
        log.info("KernelMaxWindowExtensionTestCase TestCase");
