...
public class KalmanMaxWindowExtension extends WindowProcessor implements FindableProcessor {
    ...
    protected void init(ExpressionExecutor[] attributeExpressionExecutors, ExecutionPlanContext executionPlanContext) {
        ...
        if (attributeExpressionExecutors[0].getReturnType() != Attribute.Type.DOUBLE) {
            throw new ExecutionPlanValidationException("Invalid parameter type found for the argument of KalmanMaxWindow, " +
                ...
                if (maxPos != null) {
                    ...
                    if (maxPosEvnt != null) {
                        ...
                        if (!uniqueQueue.contains(maximumEvent)) {
                            ...
                            returnChunk.add(streamEventCloner.copyStreamEvent(maximumEvent));
                        }
                    }
                }
                eventStack.remove();
